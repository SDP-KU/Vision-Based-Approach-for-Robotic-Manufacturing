...
D2E_y = 0
D2E_z = 150
D2E_rx = np.multiply(-1.6229758, 180/math.pi) 
D2E_ry = np.multiply(-0.0024435, 180/math.pi)
D2E_rz = np.multiply(2.38062460, 180/math.pi)
...
robot.MoveL(robot.SolveFK(robot.Joints())*ENDEFFECTOR_TO_CAM*transl(-40,-70,20)) # approximate value
input("again, press enter to proceed")
Drill_on()
